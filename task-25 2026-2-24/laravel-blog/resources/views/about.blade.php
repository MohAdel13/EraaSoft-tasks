                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="follow-socials">
                                        <a href="{{ route('home') }}" class="fb"><i class="ti-facebook"></i></a>
                                        <a href="{{ route('home') }}" class="twt"><i class="ti-twitter"></i></a>
                                        <a href="{{ route('home') }}" class="inst"><i class="ti-instagram"></i></a>
                                        <a href="{{ route('home') }}" class="youtube"><i class="ti-youtube"></i></a>
                                        <a href="{{ route('home') }}" class="pint"><i class="ti-pinterest"></i></a>
                                    </div>
                                </div>
                            </div>
